...
<ul>
  ...
  <li><b>Modelo Entidade Relacionamento (MER)</b> (acesse <a href="https://github.com/Lilianor/projeto_final_ipiranga/blob/master/MER.png" target="_blank">aqui</a> para visualizar o Modelo Entidade Relacionamento)</li>
  <li><b>Diagrama Entidade Relacionamento (DER)</b> (acesse <a href="https://github.com/Lilianor/projeto_final_ipiranga/blob/master/DER.png" target="_blank">aqui</a> para visualizar o Modelo Entidade Relacionamento)</li>
  <li><b>Documentação Arquitetura de Dados</b> (acesse <a href="https://github.com/Lilianor/projeto_final_ipiranga/blob/master/doc_arquiteturadedados.pdf" target="_blank">aqui</a> para visualizar a documentação em PDF)</li>
